$(document).ready(function(e) {
	   ...
	   //Nick del usuario
	   $('#nick').on("change",nick);
	   //Radio para saber si el usuario quiere cambiar al contraseña
	   ...
	   $('#principio').click(function(e) {
 	   ...
 	   // seguir añadiendo js para validar la contraseña**********************************************************************************************
	...
	//funcion para validar la contraseña antigua del usuario
	function contrasenaVieja(){
		var bandera=false;
		 if($('#contrasenaVieja').val().length>0 && $('#contrasenaVieja').val().length<=10){
				...
				$('#contrasenaVieja').attr('title',"la contraseña antigua es obligatoria, debe ser entre 1 y 10 caracteres");
				$('#contrasenaVieja').parent().addClass('has-error has-feedback');
			}	
			return bandera;
		}

	//funcion para saber si el usuario quiere cambiar la contraseña
 	...
 	function contrasena(){
 		var bandera=false;
 		 if($('#contrasena').val().length>0 && $('#contrasena').val().length<=10){
 				...
 				$('#contrasena').attr('title',"La contraseña nueva es obligatoria, debe ser entre 1 y 10 caracteres");
